...
import { Button, Card, CardBody, Chip, Divider, RadioGroup, Radio, Badge } from "@heroui/react";
import { ArrowLeft, Download, FileDown, FileText, Check, X, Monitor, Palette, Type, Lock, Share2 } from "lucide-react";
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Badge color="primary" variant="flat" className="bg-[#7170FF]/15 text-[#7170FF] border border-[#7170FF]/25">
                  {slides.length} slides
                </Badge>
                <Badge variant="flat" className="bg-[#151617] border border-white/[0.06] text-default-400">
                  16:9
                </Badge>
              </div>
            </div>
              ...
              <CardBody className="p-6 space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Chip size="sm" color="success" variant="flat" className="bg-success/15 text-success border border-success/25">
                      Included
                    </Chip>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Chip size="sm" color={brandKitApplied ? "success" : "default"} variant="flat" className={brandKitApplied ? "bg-success/15 text-success border border-success/25" : "bg-white/[0.06] text-default-400"}>
                      {brandKitApplied ? "Brand Kit" : "Default"}
                    </Chip>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Chip size="sm" color={lockedSlidesCount > 0 ? "warning" : "default"} variant="flat" className={lockedSlidesCount > 0 ? "bg-warning/15 text-warning border border-warning/25" : "bg-white/[0.06] text-default-400"}>
                      {lockedSlidesCount}
                    </Chip>
                  </div>
                </div>
